...
<!-- /banner_bottom_agile_info -->
    <div class="banner_bottom_agile_info" style="background-color: 	#003764; color: white; height: 500px;">
	    <div class="container">
			...
			<p><h1  style="text-align:center; letter-spacing:0.5em;">WHAT WE DO</h1></p>
			 	...
			 	<p><h2 style="letter-spacing:0.1em";>◉ PRODUCTS DESIGN AND MANUFATURING</h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DELEOPING THE COOLEST DESIGNS AND BRINGING INTO LIFE</p>
				<p><h2 style="letter-spacing:0.1em";>◉ RESEARCH AND DEVELOPMENT</h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EPERIMENTAL ANALYSIS</p>
				<p><h2 style="letter-spacing:0.1em";>◉ OPEN DESIGN WORKSPACE </h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WELCOME TO THE NETWORK OF DESIGNERS</p>
				  <div class="clearfix"></div>
			</div>    
	...
	<!-- team -->
<div class="banner_bottom_agile_info team" style="background-color: black;">
	<div class="container">
	            <h3 class="wthree_text_info" style="color:white;">Our Team <span>Members</span></h3>
							...
							<div class="caption">
								...
								<ul class="social-nav model-3d-0 footer-social w3_agile_social two">
									...
									<li><a href="https://twitter.com/mintarikenya/" target="0" class="twitter"> 
											<div class="front"><i class="fa fa-twitter" aria-hidden="true"></i></div>
											<div class="back"><i class="fa fa-twitter" aria-hidden="true"></i></div></a></li>
									<li><a href="www.instagram.com/mintarikenya"  target="0" class="instagram">
											<div class="front"><i class="fa fa-instagram" aria-hidden="true"></i></div>
											<div class="back"><i class="fa fa-instagram" aria-hidden="true"></i></div></a></li>
									<!-- <li><a href="#" class="pinterest">
											<div class="front"><i class="fa fa-linkedin" aria-hidden="true"></i></div>
  ...
  <!-- banner-bootom-w3-agileits -->
	<div class="banner-bootom-w3-agileits" style="color: white; background-color:#09233A;">
	   <div class="container">
		 ...
		 To provide high-end and quality pieces of art in the market</p><br>
		 <p><b style="letter-spacing:0.2em; font-size:20px; "># Vision Statement </b><br>
		 To  be the leading orgarnisation in providing quality artifacts and assets 
		 within Nairobi, Kenya and the neighbouring regions</p><br>
		 <p><b style="letter-spacing:0.2em; font-size:20px; "># Mintary Core - Values</b><br>
		 Mintari Kenya is guided by the co-values 
