				...
				<div class="col-md-4 contact-grid-agile-w3">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:mintarikenya@gmail.com">mintarikenya@gmail.com</a></p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
						...
						<h4>For More <span>Information</span></h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Telephone </p><span>+254 71 603 8007</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:mintarikenya@gmail.com">mintarikenya@gmail.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Location</p><span>Nairobi, Kenya.</span>
								</div>
								<div class="clearfix"> </div>
							</div>
